 ...
 * @param {String} component - String referring to the string selector in the adhoc web service
 *                             that determines which "service" will be called.
 * @param {Object} params - Object containing properties, these properties and their values
 *                          will be placed in the query string of the web service call
 * @param {Function} callback - function to be called when asynchronous call returns. If this
 *                              value is null or undefined, the call will be made synchronously. when the callback is
 *                              called, if the user session has expire, callback will be passed a parameter
